      ...
      <div className="mx-auto max-w-md p-4">
        ...
        <div className="mt-4 flex items-center gap-3 rounded-2xl border border-border bg-card p-4">
          <div className="flex-1">
            <div className="text-lg font-bold">Good morning, {CURRENT_DRIVER.name.split(" ")[0]}</div>
            <div className="text-xs text-muted-foreground">{driverOrders.length} deliveries assigned today</div>
          </div>
          <button
        ...
        <div className="mt-4 grid grid-cols-3 gap-2">
          <MiniStat icon={ClipboardList} tone="bg-purple-soft text-purple" value={driverOrders.length} label="Assigned" />
